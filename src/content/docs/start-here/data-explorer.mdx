...
<Aside type="caution">
Braga was retired at 23:59 CET on 12 August 2026, so the Data Explorer has nothing to read until the next public testnet — see the [Braga page](/networks/braga/) for the full story.
</Aside>
