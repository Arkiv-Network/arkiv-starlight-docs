...
<Aside>
All entities in Arkiv are stored in a shared database. In production, always tag your data with a unique project attribute to isolate it from other apps. See [Best Practices](/typescript-sdk/best-practices/#1-always-use-a-project-attribute).
</Aside>
