---
title: API Keys
description: Get an Arkiv API key from the Arkiv Hub to raise the rate limits on your RPC calls, and learn how to send it, watch your quota, and lock it down.
---

import { Aside, Steps } from '@astrojs/starlight/components';

An API key raises the rate limits on your calls to the Arkiv RPC. You get keys from the [Arkiv Hub](https://hub.arkiv.network/api-keys).
