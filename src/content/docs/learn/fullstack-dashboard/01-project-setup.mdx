...
- **An Arkiv Testnet Private Key**: To create entities (write data) on the Arkiv blockchain, you need a wallet. We'll be using the public **Braga testnet**, so no real funds are at risk.
