...
<Aside type="caution">
The Braga faucet and explorer go offline when Braga shuts down on 12 August 2026, so this step is blocked until the new testnet ships in September 2026. See the [Braga page](/networks/braga/).
</Aside>
...
<Aside type="caution">
Running the backend means sending transactions to Braga, which shuts down on 12 August 2026. There's no public network until the new testnet ships in September 2026. See the [Braga page](/networks/braga/).
</Aside>
