...
<Aside type="caution">
Braga shuts down at 23:59 CET on 12 August 2026, and there's no public network until the new testnet ships in September 2026. Running the backend and frontend below needs a live network, so this part is blocked. See the [Braga page](/networks/braga/) for details.
</Aside>
