...
1. **A Node.js backend service.** This script runs continuously. Every 60 seconds, it fetches the latest market data for Bitcoin (BTC), Ethereum (ETH), and Golem (GLM) from the CoinGecko API. It then uses the Arkiv SDK to store this data on the Cheesecake testnet.
