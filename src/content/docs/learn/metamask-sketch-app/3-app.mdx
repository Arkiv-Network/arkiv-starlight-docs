...
<Aside type="caution">
This part needs a live network — connecting MetaMask, sending the save transaction and checking the explorer link all require Braga to be up. Braga shuts down on 12 August 2026, and there's no public network until the new testnet ships in September 2026. See the [Braga page](/networks/braga/).
</Aside>
