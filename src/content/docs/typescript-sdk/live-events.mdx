---
title: Live Events
description: Watch real-time entity events with the Arkiv TypeScript SDK.
---
...
Use `fromBlock` to replay events. The replay starts from a past block:
...
<Aside type="tip">
When you no longer need events, call the returned `unwatch()` function. This stops the polling and frees resources.
</Aside>
