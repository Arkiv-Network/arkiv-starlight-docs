...
### Add the Braga Network to wagmi Config

Register the Arkiv Braga testnet in your wagmi config so wallet switching works:
...
If your app supports multiple chains, add `braga` alongside them:
