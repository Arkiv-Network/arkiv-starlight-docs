...
### Add the Tiramisu Network to wagmi Config

Register the Arkiv Tiramisu testnet in your wagmi config so wallet switching works:
...
If your app supports multiple chains, add `tiramisu` alongside them:
...
await window.ethereum.request({
  ...
  params: [{
    ...
    // No blockExplorerUrls: Tiramisu has no public explorer yet, and the field is optional.
  }],
})
