...
The protocol supports glob matching on string attributes (`attribute ~ "My_Project_*"`), but the operator is not yet exposed in the TypeScript SDK. If you need pattern matching today, use the [JSON-RPC API](/json-rpc/overview/) directly.
:::
